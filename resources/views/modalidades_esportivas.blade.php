          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Formulário de Cadastro de Modalidade</h3>
              </div>
              <form action="/post.mod" method="POST" enctype="multipart/form-data" width="100px">
                @csrf
                <div class="card-body">
                  <div class="form-group">
                    <label for=>Modalidades</label>
                    <input type="text" class="form-control" name="modalidades" id="modalidades" placeholder="Insira a modalidade">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputFile">Imagem da Modalidade</label>
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" name="image" id="image">
                        <label class="custom-file-label" for="exampleInputFile">Imagem da Modalidade</label>
                      </div>
                    </div>
                  </div>
                ...
                <table class="table table-sm">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <form action="/modalidades_esportivas/{{ $modalidade->id }}" method="POST">
                          @csrf
                          @method('DELETE')
