    ...
    <div class="over-wrap">
                            ...
                            <li class="uk-parent uk-active" data-uk-dropdown="{'preventflip':'y'}" aria-haspopup="true" aria-expanded="false"><a href="#">Pages</a>
                                <div class="uk-dropdown uk-dropdown-navbar uk-dropdown-width-1">
                                    <div class="uk-grid uk-dropdown-grid">
                                        <div class="uk-width-1-1">
                                            <ul class="uk-nav uk-nav-navbar">
                                                <li><a href="players.html">Jogadores</a>
                                                </li>
        ...
        <div class="uk-container uk-container-center alt">
            <ul class="uk-breadcrumb">
                ...
                <li class="uk-active"><span>Atletas</span>
                </li>
            </ul>
        </div>
                                ...
                                <div class="footer-wrap">
                                    <div class="foot-menu-wrap">
                                        <ul class="nav menu">
                                            ...
                                            <li class="item-166"><a href="players.html">atletas</a>
                                            </li>
                                    ...
                                    <div class="copyrights">Copyright © 2022 <a href="www.fsixtecnologia.com.br">Fsix Tecnologia</a>. Todos os Direitos Reservados.</div>
                                    <div class="clear"></div>
                                </div>
                            </div>
                        </div>
