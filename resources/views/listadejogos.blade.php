                ...
                <nav style="margin: 0px;" class="tm-navbar uk-navbar" data-uk-sticky="">
                    <div class="uk-container uk-container-center">
                        <a class="tm-logo uk-float-left" href="index.html">
                            <img src="\assets\images\logo.png" alt="logo" title="logo" width="150px">
                        </a>

                        <ul class="uk-navbar-nav uk-hidden-small">
                            <li data-uk-dropdown="{'preventflip':'y'}" aria-haspopup="true" aria-expanded="false"><a href="/portaljogos">home</a></li>
                            <li class="uk-parent uk-active" data-uk-dropdown="{'preventflip':'y'}" aria-haspopup="true" aria-expanded="false"><a href="match-list.html">Resultados</a></li>   
                        </ul>
                    ...
                    <div class="uk-panel categories-sidebar">
                        ...
                        <div>
                            <ul class="nav menu">
                                <li class="item-3">             
                                    <a href="news.html">
                                    Artilheiros <span class="label">(3)</span>
                                    </a>            
                                </li>
                                <li class="item-4">             
                                    <a href="news.html">
                                    Assistências<span class="label">(2)</span>
                                    </a>            
                                </li>
                                <li class="item-2">             
                                    <a href="news.html">
                                    Cartões <span class="label">(4)</span>
                                    </a>            
                                </li>
                                <li class="item-6">             
                                    <a href="news.html">
                                    Destaques da Partida <span class="label">(3)</span>
                                    </a>            
                                </li>
                            </ul>
                        </div>
...
<script type="text/javascript" src="assets/js2/jquery.js"></script>
<script type="text/javascript" src="assets/js2/uikit.js"></script>
<script type="text/javascript" src="assets/js2/SimpleCounter.js"></script>
<script type="text/javascript" src="assets/js2/components/grid.js"></script>
<script type="text/javascript" src="assets/js2/components/slider.js"></script>
<script type="text/javascript" src="assets/js2/components/slideshow.js"></script>
<script type="text/javascript" src="assets/js2/components/slideset.js"></script>
<script type="text/javascript" src="assets/js2/components/sticky.js"></script>
<script type="text/javascript" src="assets/js2/components/lightbox.js"></script>
<script type="text/javascript" src="assets/js2/components/accordion.js"></script>
<script type="text/javascript" src="assets/js2/isotope.pkgd.min.js"></script>

<script type="text/javascript" src="assets/js2/theme.js"></script>
