          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Formulário de Cadastro de Torneios</h3>
              </div>
              <form action="/post.torneio" method="POST" enctype="multipart/form-data" width="100px">
                @csrf
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="Date" class="form-control" name="date" id="date" placeholder="Insira a Data do Torneio">
                  </div>
                  <div class="form-group">
                    <label>Equipe</label>
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-6">              
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Torneios</h3>
              </div>
              <!-- /.card-header -->
                ...
                <table class="table table-sm">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{ $torneio->team }}</td>
                      <td>
                        <form action="/torneio/{{ $torneio ->id }}" method="POST">
                          @csrf
                          @method('DELETE')
